...
const Hero = () => {
  ...
  // Build URLs that respect Vite base (/, /yug-portfolio/, etc.)
  const headerBg = `${import.meta.env.BASE_URL}header.jpg`;               // from public/header.jpg
  const heroImg = `${import.meta.env.BASE_URL}images/yugandhar.png`;      // from public/images/yugandhar.png
        ...
        <div className="text-left max-w-2xl md:ml-[-90px] relative z-20 mt-[-24px]">
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 shadow-xl rounded-2xl p-8 mb-10 w-[110%]">
            <p className="text-gray-200 text-lg mb-6 leading-relaxed">
              Building scalable batch/streaming pipelines, RAG systems, MCP agents, semantic search, and cloud-native AI
              solutions using GCP, AWS, Azure, Spark, Beam, and Kafka.
            </p>
